  ...
  return (
    <div className="kup-landing">
      ...
      <section className="section" id="feat">
        ...
        <div className="note"><Sparkles size={16} /> <span><b>모든 초안은 언제든 직접 수정</b>할 수 있어요. 최종 결정권은 항상 당신에게 있습니다.</span></div>
      </section>
        ...
        <div className="showcase-card">
          ...
          <div className="showcase-body">
            <div className="showcase-copy">
              <h3>{active.t}</h3>
              <p>{active.d}</p>
              <a className="sc-link" href="#"><span>{active.l}</span><ArrowRight size={16} aria-hidden="true" /></a>
            </div>
        ...
        <div className="plans">
          <div className="plan">
            ...
            <ul className="plan-feats">
              <li><span className="ck"><Check size={13} strokeWidth={3} /></span>계정 1개 연동</li>
              <li><span className="ck"><Check size={13} strokeWidth={3} /></span>AI 기획·제작 기본</li>
              <li><span className="ck"><Check size={13} strokeWidth={3} /></span>DM 리드마그넷 100건</li>
            </ul>
          ...
          <div className="plan featured">
            ...
            <ul className="plan-feats">
              <li><span className="ck"><Check size={13} strokeWidth={3} /></span>계정 3개 연동</li>
              <li><span className="ck"><Check size={13} strokeWidth={3} /></span>AI 제작 무제한</li>
              <li><span className="ck"><Check size={13} strokeWidth={3} /></span>DM 1,000건 · 성과 분석</li>
            </ul>
            <AuthButton className="btn btn-primary">무료로 시작하기</AuthButton>
          </div>
          <div className="plan">
            ...
            <ul className="plan-feats">
              <li><span className="ck"><Check size={13} strokeWidth={3} /></span>계정 무제한</li>
              <li><span className="ck"><Check size={13} strokeWidth={3} /></span>DM 무제한</li>
              <li><span className="ck"><Check size={13} strokeWidth={3} /></span>우선 지원</li>
            </ul>
            <AuthButton className="btn btn-line">시작하기</AuthButton>
          </div>
        </div>
